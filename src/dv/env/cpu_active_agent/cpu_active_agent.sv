class cpu_active_agent extends uvm_agent;
  ...
  extern function new(string name = "slv_active_agent", uvm_component parent = null);
  extern function void build_phase(uvm_phase phase);
  extern function void connect_phase(uvm_phase phase);

endclass

function cpu_active_agent::new(string name = "cpu_active_agent", uvm_component parent = null);
...
function void cpu_active_agent::build_phase(uvm_phase phase);
  ...
  if(!uvm_config_db#(uvm_active_passive_enum)::get(this, "", "is_active", is_active))
    `uvm_info("CPU-ACTIVE-AGENT", "is_active undefines")
