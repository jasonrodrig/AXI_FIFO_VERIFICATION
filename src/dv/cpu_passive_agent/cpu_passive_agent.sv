class cpu_passive_agent extends uvm_agent;
  ...
  extern function new(string name = "cpu_passive_agent", uvm_component parent); 
  extern function void build_phase(uvm_phase phase);

endclass 

function cpu_passive_agent::new(string name = "cpu_passive_agent", uvm_component parent);
